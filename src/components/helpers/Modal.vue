        ...
        >
          <div class="title1 px-4 pt-3">
            <span
              ><a
                href="#"
                @click.prevent="open(projects.visit)"
          ...
          <div class="modal-body my-0 pb-0 px-4 pt-0">
            ...
            >
              <span>{{ projects.date }} • {{ projects.category }}</span>
            </div>
            <div class="pb-1 bheight">
              <span
                class="badge mr-2 mb-2"
                v-for="tech in projects.technologies"
                :key="tech"
            ...
            <div style="text-align: justify;">
              <span v-html="projects.description"></span>
            </div>
            <hr />
            <div>
              <Gallery :images="projects.pictures" />
            </div>
          </div>
